...
const MatchDetail: React.FC<MatchProps> = ({ matches }) => {
    return(
        <>
        <h1>Matches</h1>
        {matches.map(({id, match_date, show_name, wrestlers_involved_name, winner_id, match_type}) => 
                (<div className={styles.gridContainer} key={id}>
                    ...
                    <div className={styles.wrestlersInvolved}>{formatWrestlerNames(wrestlers_involved_name)}</div>
